...
<form action="" method="POST" class="needs-validation p-4 rounded" novalidate>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <input type="text" disabled="disabled" class="form-control" id="nomD" name="nomD" value="<?php echo $leDispositif->nomD ?>" required>
            <div class="invalid-feedback">Veuillez entrer le nom du dispositif</div>
        </div>
    </div>
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" disabled="disabled" id="libD" name="libD" required><?php echo $leDispositif->libD ?></textarea>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" disabled="disabled" id="objPedaD" name="objPedaD" rows="3" required><?php echo $leDispositif->objPedaD ?></textarea>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <input type="date" disabled="disabled" class="form-control" id="dateDebD" name="dateDebD" value="<?php echo $leDispositif->dateDebD ?>" required>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <input type="date" disabled="disabled" class="form-control" id="dateFinD" name="dateFinD" value="<?php echo $leDispositif->dateFinD ?>" required>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <input  type="text" disabled="disabled" class="form-control" id="modaliteD" name="modaliteD" value="<?php echo $leDispositif->modaliteD ?>" required>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
            <input type="url" disabled="disabled" class="form-control" id="lienSiteD" name="lienSiteD" value="<?php echo $leDispositif->lienSiteD ?>" required>
            <div class="invalid-feedback">Veuillez entrer un lien valide</div>
        </div>
    </div><br>
    <div>
        <button type="submit" class="btn btn-danger">Supprimer le dispositif</button>
        <a class="btn btn-primary" href="<?php echo WEBROOT.'/'.$_SESSION['controleur'].'/gestion' ?>">Annuler</a>
    </div>
</form>