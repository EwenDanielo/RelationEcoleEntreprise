<div class="table100 ver5 m-b-110" style="margin : 0 15px 0 15px;">
    ...
    <div class="table100-body js-pscroll ps ps--active-y">
        <table>
            <tbody>
                <?php 
                while ($uneIntervention = $lesInterventions->fetch()) {
                ?>
                    <tr class="row100">
                        <td class="cell100" width="15%" align="center"><?php echo $uneIntervention->idIntervention ?></td>
                        <td class="cell100" width="20%"><?php echo $uneIntervention->intituleIntervention ?></td>
                        <?php $leSecteur = getUnMetierById($uneIntervention->idMetier); ?>
                        <td class="cell100" width="15%"><?php echo $leSecteur->intituleMetier ?></td>
                        <?php $lEntreprise = getUneEntreprise($uneIntervention->idEnt) ?>
                            ...
                            <div class="d-flex flex-row">
                                <div class="p-1">
                                    <form action="<?php echo WEBROOT.'dispositif/update' ?>" method="POST">
                                        <input type="hidden" id="idIUpdate" name="idIUpdate" value="<?php echo $uneIntervention->idIntervention ?>">
                                ...
                                <div class="p-1">
                                    <form action="<?php echo WEBROOT.'dispositif/delete' ?>" method="POST">
                                        <input type="hidden" id="idIDelete" name="idIDelete" value="<?php echo $uneIntervention->idIntervention ?>">
