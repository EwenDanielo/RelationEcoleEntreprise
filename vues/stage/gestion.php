<div class="table100 ver5 m-b-110" style="margin : 0 15px 0 15px;">
        ...
        <table>
            <thead>
                <tr class="row100 head">
                    <th class="cell100" width="15%">Identifiant Stage</th>
    ...
    <div class="table100-body js-pscroll ps ps--active-y">
        <table>
            <tbody>
                <?php 
                while ($unStage = $lesStages->fetch()) {
                ?>
                    <tr class="row100">
                        <td class="cell100" width="15%" align="center"><?php echo $unStage->idS ?></td>
                        <td class="cell100" width="20%"><?php echo $unStage->intituleS ?></td>
                        <?php $leSecteur = getUnSecteurById($unStage->idSecteur); ?>
                        <td class="cell100" width="15%"><?php echo $leSecteur->nomSecteur ?></td>
                        <?php $lEntreprise = getUneEntreprise($unStage->idEnt) ?>
                            ...
                            <div class="d-flex flex-row">
                                <div class="p-1">
                                    <form action="<?php echo WEBROOT.'dispositif/update' ?>" method="POST">
                                        <input type="hidden" id="idSUpdate" name="idSUpdate" value="<?php echo $unStage->idS ?>">
                                ...
                                <div class="p-1">
                                    <form action="<?php echo WEBROOT.'dispositif/delete' ?>" method="POST">
                                        <input type="hidden" id="idSDelete" name="idSDelete" value="<?php echo $unStage->idS ?>">
